...
## -- B.1 --  TabPanel 1: Impressum ---------------------------------------------------------------
          tabPanel("Impressum",
            ...
            p(),
            h4("Alle Angebote sind freibleibend. Der Autor behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen."),
            h3("Haftungsausschluss für Inhalte und Links"),
            h4("Verweise und Links auf Webseiten Dritter liegen ausserhalb unseres Verantwortungsbereichs. Es wird jegliche Verantwortung für solche Webseiten abgelehnt. Der Zugriff und die Nutzung solcher Webseiten erfolgen auf eigene Gefahr des jeweiligen Nutzers."),
            h3("Urheberrechtserklärung"),
            h4("Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf dieser Website, gehören ausschliesslich den genannten Rechteinhabern. Für die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung des Urheberrechtsträgers im Voraus einzuholen."),
            h3("Quelle Impressum"),
            h4(tags$a(href="https://brainbox.swiss/impressum-generator-schweiz/", "BrainBox Solutions"))
          ),
